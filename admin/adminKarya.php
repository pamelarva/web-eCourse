...
<head>
  ...
  <!--Style -->
  <link rel="stylesheet" type="text/css" href="CSS/styleKarya.css">
</head>
      ...
      <h1>Daftar Karya Siswa</h1>
        ...
        <table class="table">
            ...
            <tbody>
                <?php 
                    include ('koneksi.php');
                    $query_karya = "SELECT * FROM upload_karya";
                    $result_karya = mysqli_query($koneksi, $query_karya);
                    $i = 1;
                      while ($row_karya = mysqli_fetch_assoc($result_karya)) {
                      ?>
              <tr>
                <td width='30'><?php echo $row_karya['id_upload']; ?></td>
                <td width='150'><?php echo $row_karya['username']; ?></td>
                <td width='100'><?php echo $row_karya['judul_kelas']; ?></td>
                <td width='100'><?php echo "<image width='60px' src='../hasilkarya/".$row_karya['gambar']."'>"?></td>
                <td width='100'> 
                  <a class='btn btn btn-outline-light' style="background-color: #0c134f" href='hapus_karya.php?id_upload=<?php echo $row_karya['id_upload']; ?>' onmouseover="this.style.backgroundColor='#f29727'" onmouseout="this.style.backgroundColor='#0c134f'">Hapus</a>
                </td>
              </tr>
              <?php
              }
