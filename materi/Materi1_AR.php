...
<html lang="en">
  <head>
    ...
    <title>Code Masterclass || Materi Kelas AR/VR</title>
    <link
...
<header>
    ...
    <section class="materi">
      <a class="back-to-home" href="Materi_AR.php">Kembali ke Beranda Kelas</a>
      <div class="container">
        <h1 class="title">AR / VR</h1>
        <h5>Mengembangkan Teknologi Menggunakan AR/VR</h5>
      </div>
      <div class="accordion">
