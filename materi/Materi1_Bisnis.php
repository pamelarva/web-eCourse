...
<html lang="en">
  <head>
    ...
    <title>Code Masterclass || Materi Kelas Bisnis Digital</title>
    <link
...
<header>
    ...
    <section class="materi">
      <a class="back-to-home" href="Materi_Bisnis.php">Kembali ke Beranda Kelas</a>
      <div class="container">
      <h1 class="title">
            Bisnis Digital
        </h1>
        <h5>Mulai usaha mu sejak dini</h5>
      </div>
      <div class="accordion">
