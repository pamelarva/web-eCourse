...
<html lang="en">
  <head>
    ...
    <title>Code Masterclass || Materi Kelas UI</title>
    <link
...
<header>
    ...
    <section class="materi">
      <a class="back-to-home" href="Materi_UI.php">Kembali ke Beranda Kelas</a>
      <div class="container">
        <h1 class="title">UI Design for Mobile Apps</h1>
