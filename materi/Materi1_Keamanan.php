...
<html lang="en">
  <head>
    ...
    <title>Code Masterclass || Materi Kelas Keamanan Siber</title>
    <link
...
<header>
    ...
    <section class="materi">
      <a class="back-to-home" href="Materi_Keamanan.php">Kembali ke Beranda Kelas</a>
      <div class="container">
        <h1 class="title">Siber</h1>
        <h5>Melakukan keamaan siber yang semestinya</h5>
      </div>
      <div class="accordion">
